...
public class TripleConverterTest {
	...
	private static TripleConverterPortuguese converter;
	 ...
	 */
	@Test
	public void testConvertTriplesToText() throws IOException {
		...
		triples.add(
				Triple.create(subject, RDF.type.asNode(), NodeFactory.createURI("http://dbpedia.org/ontology/Person")));
		...
		triples.add(Triple.create(subject, NodeFactory.createURI("http://dbpedia.org/ontology/birthDate"),
	...
	/**
	 * Test method for
	 * {@link org.aksw.triple2nl.TripleConverter#convert(org.apache.jena.graph.Triple)}.
	 * @throws IOException 
	 */
	@Test
	public void testConvertTripleToTextTriple() throws IOException {
