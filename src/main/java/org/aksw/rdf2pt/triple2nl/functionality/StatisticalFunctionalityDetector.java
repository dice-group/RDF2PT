 ...
 * #L%
 */
package org.aksw.rdf2pt.triple2nl.functionality;
...
//		man.saveOntology(functional, new RDFXMLOntologyFormat(), new FileOutputStream(new File("resources/dbpedia_functional_axioms.owl")));
		StatisticalFunctionalityDetector detector = new StatisticalFunctionalityDetector(new File("/Users/diegomoussallem/Documents/workspace/sw2pt/src/main/resources/dbpedia_functional_axioms.owl"), 0.9);
